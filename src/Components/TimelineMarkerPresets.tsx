...
function PresetButtons() {
	...
	let content = <div style={{lineHeight: "2em"}}>
		...
		<LoadCombinedTracksBtn displayName={"P9S by Yara"} url={"/ffxiv-blm-rotation/presets/markers/p9s.txt"}/>
		<LoadCombinedTracksBtn displayName={"P10S by Tischel"} url={"/ffxiv-blm-rotation/presets/markers/p10s.txt"}/>
		<LoadCombinedTracksBtn displayName={"P11S by Lilian"} url={"/ffxiv-blm-rotation/presets/markers/p11s.txt"}/>
		<LoadCombinedTracksBtn displayName={"P12S P1 by Yara"} url={"/ffxiv-blm-rotation/presets/markers/p12s_p1.txt"}/>
		<LoadCombinedTracksBtn displayName={"P12S P2 by Yara"} url={"/ffxiv-blm-rotation/presets/markers/p12s_p2.txt"}/>
		<br/>
		<span>{localize({en: "Current tier (zh), from 不打冰3攻略组: ", zh: "当前版本（中文），来自不打冰3攻略组："})}</span>
		<LoadCombinedTracksBtn displayName={"P9S"} url={"/ffxiv-blm-rotation/presets/markers/p9s_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P10S"} url={"/ffxiv-blm-rotation/presets/markers/p10s_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P11S（错误较多）"} url={"/ffxiv-blm-rotation/presets/markers/p11s_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P12S门神"} url={"/ffxiv-blm-rotation/presets/markers/p12s_p1_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P12S本体"} url={"/ffxiv-blm-rotation/presets/markers/p12s_p2_zh.txt"}/>
		<br/>
		<LoadCombinedTracksBtn displayName={"P1S Shackles of Time first"} url={"/ffxiv-blm-rotation/presets/markers/p1s_shackles_of_time_first.txt"}/>
		<LoadCombinedTracksBtn displayName={"P1S Aetherial Shackles first"} url={"/ffxiv-blm-rotation/presets/markers/p1s_aetherial_shackles_first.txt"}/>
		<LoadCombinedTracksBtn displayName={"P2S"} url={"/ffxiv-blm-rotation/presets/markers/p2s.txt"}/>
		<br/>
		...
		<LoadCombinedTracksBtn displayName={"P5S"} url={"/ffxiv-blm-rotation/presets/markers/p5s_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P6S"} url={"/ffxiv-blm-rotation/presets/markers/p6s_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P7S"} url={"/ffxiv-blm-rotation/presets/markers/p7s_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P8S门神蛇轴"} url={"/ffxiv-blm-rotation/presets/markers/p8s_p1_snake_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P8S门神车轴"} url={"/ffxiv-blm-rotation/presets/markers/p8s_p1_beast_zh.txt"}/>
		<LoadCombinedTracksBtn displayName={"P8S本体"} url={"/ffxiv-blm-rotation/presets/markers/p8s_p2_zh.txt"}/>
	</div>
